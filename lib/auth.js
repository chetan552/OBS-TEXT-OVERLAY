...
/**
 * Async twin of verifyPassword, for the server's login routes. scrypt at
 * N=16384 holds the CPU for ~50 ms, and doing that synchronously inside a
 * request handler means a handful of parallel login attempts stall the
 * whole event loop. Same guarantees: constant-time compare, never throws
 * on malformed input.
 */
